...
import org.techishthoughts.arrow.service.ArrowSerializationServiceV2;
...
@RestController
@RequestMapping("/api/arrow/v2")
public class ArrowBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(ArrowBenchmarkControllerV2.class);

    private final ArrowSerializationServiceV2 serializationService;

    public ArrowBenchmarkControllerV2(ArrowSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/arrow/v2/benchmark",
            "info", "/api/arrow/v2/info",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Arrow benchmark with config: {}", config);
            ...
            logger.info("Arrow benchmark completed successfully");
