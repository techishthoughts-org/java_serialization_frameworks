...
/**
 * Modernized Avro benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/avro/v2")
public class AvroBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(AvroBenchmarkControllerV2.class);

    private final AvroSerializationService serializationService;

    public AvroBenchmarkControllerV2(AvroSerializationService serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/avro/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Avro benchmark with config: {}", config);
            ...
            logger.info("Avro benchmark completed successfully");
