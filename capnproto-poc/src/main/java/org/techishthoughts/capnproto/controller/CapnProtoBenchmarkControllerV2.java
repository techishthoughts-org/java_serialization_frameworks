...
import org.techishthoughts.capnproto.service.CapnProtoSerializationServiceV2;
...
/**
 * Modernized Cap'n Proto benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/capnproto/v2")
public class CapnProtoBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(CapnProtoBenchmarkControllerV2.class);

    private final CapnProtoSerializationServiceV2 serializationService;

    public CapnProtoBenchmarkControllerV2(CapnProtoSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/capnproto/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Cap'n Proto benchmark with config: {}", config);
            ...
            logger.info("Cap'n Proto benchmark completed successfully");
