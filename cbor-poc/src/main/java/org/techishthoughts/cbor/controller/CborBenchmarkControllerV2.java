...
import org.techishthoughts.cbor.service.CborSerializationServiceV2;
...
@RestController
@RequestMapping("/api/cbor/v2")
public class CborBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(CborBenchmarkControllerV2.class);

    private final CborSerializationServiceV2 serializationService;

    public CborBenchmarkControllerV2(CborSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/cbor/v2/benchmark",
            "info", "/api/cbor/v2/info",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting CBOR benchmark with config: {}", config);
            ...
            logger.info("CBOR benchmark completed successfully");
