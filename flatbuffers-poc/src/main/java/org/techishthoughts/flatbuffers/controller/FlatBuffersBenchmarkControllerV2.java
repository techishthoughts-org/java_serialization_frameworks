...
import org.techishthoughts.flatbuffers.service.FlatBuffersSerializationServiceV2;
...
/**
 * Modernized FlatBuffers benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/flatbuffers/v2")
public class FlatBuffersBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(FlatBuffersBenchmarkControllerV2.class);

    private final FlatBuffersSerializationServiceV2 serializationService;

    public FlatBuffersBenchmarkControllerV2(FlatBuffersSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/flatbuffers/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting FlatBuffers benchmark with config: {}", config);
            ...
            logger.info("FlatBuffers benchmark completed successfully");
