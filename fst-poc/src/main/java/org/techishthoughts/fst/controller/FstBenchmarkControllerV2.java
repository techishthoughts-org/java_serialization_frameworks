...
import org.techishthoughts.fst.service.FstSerializationServiceV2;
...
/**
 * Modernized FST benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/fst/v2")
public class FstBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(FstBenchmarkControllerV2.class);

    private final FstSerializationServiceV2 serializationService;

    public FstBenchmarkControllerV2(FstSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/fst/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting FST benchmark with config: {}", config);
            ...
            logger.info("FST benchmark completed successfully");
