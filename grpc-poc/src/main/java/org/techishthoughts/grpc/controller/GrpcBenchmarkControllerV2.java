...
import org.techishthoughts.grpc.service.GrpcSerializationServiceV2;
...
/**
 * Modernized gRPC benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/grpc/v2")
public class GrpcBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(GrpcBenchmarkControllerV2.class);

    private final GrpcSerializationServiceV2 serializationService;

    public GrpcBenchmarkControllerV2(GrpcSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/grpc/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting gRPC benchmark with config: {}", config);
            ...
            logger.info("gRPC benchmark completed successfully");
