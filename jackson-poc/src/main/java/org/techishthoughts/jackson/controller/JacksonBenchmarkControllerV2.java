...
import org.techishthoughts.jackson.service.JacksonSerializationServiceImpl;
...
/**
 * Modernized Jackson benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/jackson/v2")
public class JacksonBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(JacksonBenchmarkControllerV2.class);

    private final JacksonSerializationServiceImpl serializationService;

    public JacksonBenchmarkControllerV2(JacksonSerializationServiceImpl serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/jackson/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Jackson benchmark with config: {}", config);
            ...
            logger.info("Jackson benchmark completed successfully");
