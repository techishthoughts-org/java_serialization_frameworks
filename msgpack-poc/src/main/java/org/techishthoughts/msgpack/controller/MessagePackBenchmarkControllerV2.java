...
/**
 * Modernized MessagePack benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/msgpack/v2")
public class MessagePackBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(MessagePackBenchmarkControllerV2.class);

    private final MessagePackSerializationService serializationService;

    public MessagePackBenchmarkControllerV2(MessagePackSerializationService serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/msgpack/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting MessagePack benchmark with config: {}", config);
            ...
            logger.info("MessagePack benchmark completed successfully");
