...
import org.techishthoughts.parquet.service.ParquetSerializationServiceV2;
...
@RestController
@RequestMapping("/api/parquet/v2")
public class ParquetBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(ParquetBenchmarkControllerV2.class);

    private final ParquetSerializationServiceV2 serializationService;

    public ParquetBenchmarkControllerV2(ParquetSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/parquet/v2/benchmark",
            "info", "/api/parquet/v2/info",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Parquet benchmark with config: {}", config);
            ...
            logger.info("Parquet benchmark completed successfully");
