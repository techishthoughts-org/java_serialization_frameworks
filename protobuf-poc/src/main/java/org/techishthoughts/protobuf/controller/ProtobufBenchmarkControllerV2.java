...
/**
 * Modernized Protobuf benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/protobuf/v2")
public class ProtobufBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(ProtobufBenchmarkControllerV2.class);

    private final ProtobufSerializationService serializationService;

    public ProtobufBenchmarkControllerV2(ProtobufSerializationService serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/protobuf/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Protobuf benchmark with config: {}", config);
            ...
            logger.info("Protobuf benchmark completed successfully");
