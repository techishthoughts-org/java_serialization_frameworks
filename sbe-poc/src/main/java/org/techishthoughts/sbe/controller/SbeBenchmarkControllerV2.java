...
import org.techishthoughts.sbe.service.SbeSerializationServiceV2;
...
@RestController
@RequestMapping("/api/sbe/v2")
public class SbeBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(SbeBenchmarkControllerV2.class);

    private final SbeSerializationServiceV2 serializationService;

    public SbeBenchmarkControllerV2(SbeSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/sbe/v2/benchmark",
            "info", "/api/sbe/v2/info",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting SBE benchmark with config: {}", config);
            ...
            logger.info("SBE benchmark completed successfully");
