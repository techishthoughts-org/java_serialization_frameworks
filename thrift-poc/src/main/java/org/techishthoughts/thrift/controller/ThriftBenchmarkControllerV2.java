...
import org.techishthoughts.thrift.service.ThriftSerializationServiceV2;
...
/**
 * Modernized Thrift benchmark controller using the new service architecture.
 * Provides clean API endpoints with proper error handling and standardized responses.
 */
@RestController
@RequestMapping("/api/thrift/v2")
public class ThriftBenchmarkControllerV2 {

    private static final Logger logger = LoggerFactory.getLogger(ThriftBenchmarkControllerV2.class);

    private final ThriftSerializationServiceV2 serializationService;

    public ThriftBenchmarkControllerV2(ThriftSerializationServiceV2 serializationService) {
    ...
    public Map<String, Object> getFrameworkInfo() {
        ...
        info.put("endpoints", Map.of(
            "benchmark", "/api/thrift/v2/benchmark",
    ...
    public Map<String, Object> runBenchmark(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            logger.info("Starting Thrift benchmark with config: {}", config);
            ...
            logger.info("Thrift benchmark completed successfully");
