...
/**
 * Thrift Serialization Service
 *
 * Provides Thrift-style serialization benchmarking using JSON as the underlying format
 * for testing purposes. This allows us to test Thrift performance characteristics
 * without complex Thrift schema compilation issues.
 */
@Service
public class ThriftSerializationService {
    ...
    public ThriftSerializationService() {
    ...
    public Map<String, Object> benchmarkSerialization(List<User> users, int iterations) {
        ...
        results.put("framework", "Apache Thrift (JSON)");
    ...
    public Map<String, Object> benchmarkCompression(List<User> users, int iterations) {
        ...
        Map<String, Object> results = new HashMap<>();
        results.put("framework", "Apache Thrift (JSON) + GZIP");
        results.put("serializationTimeMs", totalSerializationTime / 1_000_000.0 / iterations);
    ...
    /**
     * Serialize users to byte array using JSON (Thrift-style)
     */
    ...
    /**
     * Deserialize users from byte array using JSON (Thrift-style)
     */
